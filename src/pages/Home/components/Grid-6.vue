<template>
  ...
  />
  <div
  class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[2] text-[1.2vw] leading-none gap-[0.1vw] w-[60%] flex flex-col items-center justify-center uppercase text-white"
